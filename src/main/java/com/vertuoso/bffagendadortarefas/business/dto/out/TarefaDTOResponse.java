...
public class TarefaDTOResponse {
    ...
    public TarefaDTOResponse() {
    }

    public TarefaDTOResponse(String id, String nomeTarefa, String descricao, LocalDateTime dataCriacao, LocalDateTime dataEvento, String emailUsuario, LocalDateTime dataAlteracao, StatusNotificacaoEnum statusNotificacaoEnum) {
        this.id = id;
